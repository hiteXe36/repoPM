...
<a href="javascript:oeffnefenster('http://pflegemedien.de/mailf/mail.php');">Mailformular</a> 
<?php echo guestbooklink();?><?php echo tag('br');?>
...
<!--
<a href="http://www.cmsimple.dk/" target="_blank">Powered by CMSimple</a> | <?php echo loginlink();?>
-->
